...
"""
Run this file to reproduce all the experiments in:
...
if __name__ == "__main__":
    ...
    show.plot_testing_boundedness_iso(Out0[0], Out0[1], [Out0[2], Out1[2]], [Out0[3], Out1[3]],
                                  'Results/testing_boundedness_isotropic.pdf')
    show.plot_testing_boundedness_ani(Out0[0], Out0[1], [Out2[2], Out3[2]], [Out2[3], Out3[3]],
    ...
    if Save == True:
        to_save = Out1 + Out2 + Out3 + Out4 + Out5 + Out6 + Out7 + Out8 + Out9 + Out10
